...
@section('content')
    ...
    <div class="panel panel-flat">
        ...
        <div class="panel-body">
            <form class="form-horizontal form-validate-jquery" method="POST" action="{{route('subscriber.update')}}">
                {{ csrf_field() }}
                <input type="hidden" name="id" value="{{$subscriber->id}}">
                <fieldset class="content-group">
                    <legend class="text-bold">{{__('newsletter.subscriber.information')}}</legend>
                    ...
                    <div class="form-group has-feedback">
                        ...
                        <div class="col-lg-9">
                            <input type="text" name="email" class="form-control" required="required" value="{{$subscriber->email}}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <label class="checkbox-inline checkbox-switch">
                                <input type="checkbox" name="status" @if($subscriber->status) checked @endif value="1" class="switch">
                            </label>
                        </div>
                    </div>
                    <!-- /inline switch group -->
