...
@section('page.button')
    <div class="heading-elements">
        ...
        <a href="{{route('blog.category.rebuild')}}"
            ...
            @foreach($categories as $category)
                <tr>
                    ...
                    <td class="text-center">
                        <ul class="icons-list">
                            <li><a href="{{route('blog.category.edit', ['id'=> $category->id])}}"> <i class="fa fa-edit"></i></a>
                            </li>
                            <li><a href="{{route('blog.category.delete', ['id'=> $category->id])}}" class="confirm-delete-action"> <i
